...
function setupProductForm(screen) {
    ...
    addButton.addEventListener(
        ...
        () => {
            ...
            /*
             * موجودی هنگام باز شدن فرم
             * همیشه کاملاً خالی است.
             */
    ...
    if (saveButton) {
        ...
        saveButton.addEventListener(
            ...
            async () => {
                ...
                /*
                 * اگر موجودی خالی باشد،
                 * آن را صفر در نظر می‌گیریم.
                 */
